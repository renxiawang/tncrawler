...
def main():
  ...
  print "Load unvisited profiles queue: ", len(profiles_queue)
  print "Load visited profiles queue: ", len(visited_profiles_queue)
  print "Load unvisited followings queue: ", len(followings_queue)
  print "Load visited followings queue: ", len(visited_followings_queue)
  print "Load unvisited followers queue: ", len(followers_queue)
